            ...
            <div class="container">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow-lg mb-4 border-left-primary border-right-primary" >
                                <div class="card-header py-3">
                                    <h3 class="m-0 font-weight-bold text-primary text-center">Manage Your Category</h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3"></div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow-lg mb-4">
                        <div class="card-header py-3">
                            <a href="{{route('category.create')}}" class="btn btn-primary btn-icon-split btn-sm float-right" >
